            ...
            {step === 1 && (
              ...
              >
                <div className="space-y-4">
                  <label className="block text-xs md:text-sm font-bold tracking-widest uppercase opacity-60">
                    How many days?
                  </label>
                  <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <span className="text-3xl md:text-4xl font-serif w-10 md:w-12 text-center">
            ...
            {step === 4 && itinerary && (
              ...
              >
                <div className="text-center border-b border-[#d9c0a5] pb-6 md:pb-8">
                  <h3 className="text-2xl md:text-3xl font-serif mb-3 md:mb-4 text-[#473c35]">
                    {itinerary.title}
                  </h3>
                  <p className="text-xs md:text-sm text-[#473c35]/80 leading-relaxed">
                    {itinerary.summary}
                  </p>
                </div>
                  ...
                  {itinerary.days.map((day, idx) => (
                    <div className="relative pl-6 md:pl-8 border-l border-[#473c35]/30">
                      ...
                      <div className="mb-4 md:mb-6">
                        <span className="text-[#473c35] text-[9px] md:text-[10px] font-bold tracking-[0.2em] md:tracking-[0.3em] uppercase">
                          Day {day.day}
                        </span>
                        <h4 className="text-xl md:text-2xl font-serif mt-1 text-[#473c35]">
                          {day.title}
                        </h4>
                      </div>
                        ...
                        {day.activities.map((act, aidx) => (
                          ...
                          >
                            ...
                            <div className="space-y-1">
                              <h5 className="font-bold text-sm text-[#473c35]">
                                {act.activity}
                              </h5>
                              <p className="text-[11px] md:text-xs text-[#473c35]/80 leading-relaxed text-justify">
                                {act.description}
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 pt-6 md:pt-8 border-t border-white/5">
                        <div>
                          <span className="text-[9px] md:text-[10px] font-bold tracking-widest uppercase opacity-40 block mb-2 md:mb-3">
                            Meals
                          </span>
                          <div className="flex flex-wrap gap-2">
                            {day.meals.map((m) => (
                              <span
                                key={m}
                                className="px-2.5 py-1 bg-[#473c35]/10 rounded-full text-[8px] md:text-[9px] font-bold uppercase tracking-wider text-[#473c35]"
                              >
                                {m}
                              </span>
                            ))}
                ...
                {itinerary.totalEstimatedPrice && (
                  <div className="bg-[#f5f0e7] rounded-xl md:rounded-2xl p-5 md:p-6 text-center border border-[#d9c0a5]">
                    <span className="text-[9px] md:text-[10px] font-bold tracking-widest uppercase text-[#473c35]/70 block mb-1 md:mb-2">
                      Estimated Investment
                    </span>
                    <p className="text-2xl md:text-3xl font-serif text-[#473c35]">
                      {itinerary.totalEstimatedPrice}
                    </p>
                  </div>
                )}
