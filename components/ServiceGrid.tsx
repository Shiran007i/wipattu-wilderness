    ...
    <section className="relative leaf-pattern pb-20">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 shadow-2xl">
          ...
          <div className="bg-[#065F46] p-8 sm:p-10 md:p-12 text-white flex flex-col justify-center min-h-[280px] sm:min-h-[320px] md:min-h-[400px]">
            <span className="text-[10px] font-bold opacity-60 mb-4 tracking-widest text-emerald-300">
              03.
            </span>
            <h3 className="text-xl font-serif mb-4 uppercase tracking-wider">
