...
const BookingSelection: React.FC<BookingSelectionProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-[#F1FDF8] text-[#064E3B]">
      <section className="relative h-[40vh] md:h-[50vh] w-full flex items-center justify-center overflow-hidden pt-16 md:pt-20">
        ...
        <div className="container mx-auto px-4 z-10 text-center text-white mt-8 md:mt-10">
          ...
          <div className="flex items-center justify-center gap-3 md:gap-4 text-[8px] md:text-[10px] font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase opacity-80">
            <span>HOME</span><span className="opacity-40">/</span><span className="text-emerald-400">WILPATTU</span>
          </div>
        </div>
      </section>
      ...
      <div className="bg-[#064E3B] text-white py-3 md:py-4 border-y border-white/10">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl flex flex-wrap items-center justify-center gap-4 md:gap-8 text-[9px] md:text-[11px] font-bold tracking-widest uppercase">
           <div className="flex items-center gap-2"><i className="fa-solid fa-circle-info text-emerald-400"></i><span>Max 2 Adults & 1 Child per Room</span></div>
           <div className="flex items-center gap-2"><i className="fa-solid fa-child text-emerald-400"></i><span>Children under 5 stay free</span></div>
           <div className="flex items-center gap-2 text-emerald-400"><i className="fa-solid fa-mug-hot"></i><span>Free Breakfast</span></div>
        </div>
      </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            <div className="w-full lg:w-[70%] space-y-6 md:space-y-8">
              <div className="bg-white shadow-sm border border-emerald-100 overflow-hidden rounded-xl">
                {/* Header for Desktop */}
                <div className="hidden md:grid grid-cols-[2fr_0.8fr_1.8fr_1fr] bg-[#064E3B] text-white text-[10px] font-bold uppercase tracking-wider p-4">
                ...
                <div className="flex flex-col md:grid md:grid-cols-[2fr_3.6fr]">
                  {/* Room Info */}
                  <div className="p-6 md:p-8 border-b md:border-b-0 md:border-r border-emerald-50 bg-emerald-50/10">
                    ...
                    <ul className="flex flex-wrap md:flex-col gap-4 md:gap-3 text-[10px] md:text-[11px] text-[#064E3B]/70 font-medium">
                  ...
                  <div className="divide-y divide-emerald-50">
                    {PLANS.map((plan) => (
                      <div key={plan.id} className="flex flex-col md:grid md:grid-cols-[0.8fr_1.8fr_1fr] items-center p-6 md:p-0 hover:bg-emerald-50/30 transition-colors">
                        ...
                        <div className="w-full md:p-6 text-center md:text-left mb-4 md:mb-0">
                          <div className="md:hidden text-[9px] font-bold text-emerald-600 uppercase tracking-widest mb-2">Package</div>
                          <h4 className="text-sm md:text-base font-bold text-[#064E3B] mb-1">{plan.name}</h4>
                          <div className="flex flex-col items-center md:items-start">
                            ...
                            <span className="text-[9px] font-bold text-emerald-600 mt-1">Total Stay: USD {plan.nightlyPrice * nights} ({nights} N)</span>
                          </div>
                        </div>
                        ...
                        <div className="w-full md:p-6 flex flex-col items-center justify-center border-t md:border-t-0 border-emerald-50 pt-4 md:pt-0">
                          <div className="md:hidden text-[9px] font-bold text-emerald-600 uppercase tracking-widest mb-3">Number of Tents</div>
            ...
            <div className="w-full lg:w-[30%]">
              <div className="bg-white shadow-2xl rounded-2xl overflow-hidden border border-emerald-100 sticky top-24">
                <div className="bg-[#064E3B] p-5 text-center">
                ...
                <div className="p-6 md:p-8">
                  <div className="space-y-6 mb-8">
                    <div className="pb-4 border-b border-emerald-50">
                      <p className="text-[9px] md:text-[10px] uppercase font-bold text-emerald-600 tracking-widest mb-1.5">Stay Period</p>
                      <div className="flex items-center justify-between">
                        <p className="text-sm md:text-base font-serif font-medium">{checkIn} — {checkOut}</p>
                        <span className="text-[10px] bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded-full font-bold">{nights} N</span>
                      </div>
                    </div>
                    <div className="pb-4 border-b border-emerald-50">
                      <p className="text-[9px] md:text-[10px] uppercase font-bold text-emerald-600 tracking-widest mb-1.5">Selected Accommodation</p>
                    ...
                    <div className="pb-4 border-b border-emerald-50">
                      <p className="text-[9px] md:text-[10px] uppercase font-bold text-emerald-600 tracking-widest mb-1.5">Occupancy</p>
                      <p className="text-sm md:text-base font-serif font-medium">{adults} Adult(s), {childrenCount} Child(ren)</p>
                    </div>
                    <div className="pt-2">
                      <p className="text-[9px] md:text-[10px] uppercase font-bold text-emerald-600 tracking-widest mb-2">Price Breakdown</p>
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between border-t border-emerald-100 pt-3 mt-2">
                          <p className="text-xs font-bold text-[#064E3B] uppercase tracking-widest">Total Stay</p>
                          <p className="text-xl font-serif font-bold text-emerald-600">USD {totalStayPrice.toFixed(2)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <button 
                    ...
                    className={`w-full py-5 text-[11px] font-bold uppercase tracking-[0.3em] rounded-xl shadow-xl transition-all duration-300 ${
                      isCapacitySufficient && totalRoomsSelected > 0 
                        ? 'bg-emerald-600 text-white hover:bg-[#022C22] transform hover:-translate-y-1 active:scale-95' 
